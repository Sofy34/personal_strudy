...
if all(xr2(1,:)-xr1(1,:)>=0)
    disp('positive disparity')
elseif all(xr2(1,:)-xr1(1,:)<=0)
    disp('negative disparity')
else
    disp('warning: mixed disparity')
end
...
[R12,t12] = relative_lin(x2, x1, K, K);
fprintf('Relative ___lin SO3 error:\t %0.5g \n', normF(R12 - G12(1:3,1:3)));

[R12,t12] = relative_nonlin(R12,t12 ,x2, x1, K, K);
